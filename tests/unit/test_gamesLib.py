...
def test_filter_games_search_term_none():
    batch_of_games = [{'title': 'Game 1', 'genres': [{'genre_name': 'Action'}]},
                      {'title': 'Game 2', 'genres': [{'genre_name': 'Adventure'}]}]
    search_term = None
...
def test_filter_games_by_genre():
    ...
    assert result == [{'title': 'Game 1', 'genres': [{'genre_name': 'Action'}]}]
...
def test_filter_games_by_title():
    ...
    assert result == [{'title': 'Game 2', 'genres': [{'genre_name': 'Adventure'}]}]
...
def test_filter_games_by_publisher():
    batch_of_games = [{'title': 'Game 1', 'publisher': {'publisher_name': 'Publisher A'}},
                      {'title': 'Game 2', 'publisher': {'publisher_name': 'Publisher B'}}]
    search_term = 'Publisher A'
    search_category = 'publisher'
    
    result = filter_games(batch_of_games, search_term, search_category)
    
    assert result == [{'title': 'Game 1', 'publisher': {'publisher_name': 'Publisher A'}}]
